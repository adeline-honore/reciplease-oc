...
class IngredientsTestCase: XCTestCase {
    ...
    private func initSUT(isFailed: Bool = false) {
        ingredientsService = IngredientsService(network: NetworkFake(testCase: .ingredients, isFailed: isFailed))
    }
    ...
    func testIngredientsServiceShouldPostSuccess() {
        // Given
        initSUT()
        // When
        let expectation = XCTestExpectation(description: "Wait for queue change")
        // Then
        ingredientsService.getData(ingredients: ingredients) { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(_):
    ...
    func testIngredientsServiceShouldPostSuccessOnDataLabelValue() {
        // Given
    ...
    func testIngredientsServiceShouldPostSuccessOnDataImageValue() {
        // Given
    ...
    func testIngredientsServiceShouldPostSuccessOnDataUrlValue() {
        // Given
    ...
    func testIngredientsServiceShouldPostSuccessOnDataIngredientLinesValue() {
        // Given
    ...
    func testIngredientsServiceShouldPostSuccessOnDataTotalTimeValue() {
        // Given
